...
meta = pd.read_json('./data/song_meta.json', encoding='utf-8')
...
train = pd.read_json('./data/train_with_tt_token.json', orient='table', encoding='utf-8')
val = pd.read_json('./data/test_with_tt_token.json', orient='table', encoding='utf-8')
