...
train.to_json('./data/train_with_tt_token.json', orient='table')
val.to_json('./data/val_with_tt_token.json', orient='table')
test.to_json('./data/test_with_tt_token.json', orient='table')
